...
export default function AyurvedaLanding() {
  ...
  const getVisibleExperts = () => {
    ...
    for (let i = 0; i < cardsToShow; i++) {
      visible.push(experts[(expertIndex + i) % experts.length]);
    }
    return visible;
  };
  ...
  return (
    <div className="w-full overflow-x-hidden bg-gradient-to-br from-lime-50 via-green-50 to-amber-50">
      ...
      {/* Services Section */}
      <section className="py-12 sm:py-10  px-4 sm:px-6 lg:px-20 bg-gradient-to-br from-lime-100 via-green-50 to-amber-100">
        <motion.div
      ...
      {/* Upcoming Events */}
      <section className="py-12 sm:py-10 px-4 sm:px-6 lg:px-20 bg-gradient-to-br from-green-50 to-lime-100">
        <motion.div
              ...
              >
                {event.img ? (
                  <>
                    ...
                    <div className="p-5 sm:p-6">
                      <h5 className="font-semibold text-green-900 text-center mb-3 text-base sm:text-lg">
                        {event.title}
                      </h5>
                  ...
                  <div className="text-center p-5">
                    <motion.div
                      ...
                      className="text-5xl sm:text-6xl mb-4 text-green-600"
                    >
                      {event.icon}
                    </motion.div>
                    <h5 className="font-semibold text-green-900 text-lg sm:text-xl mb-2">
                      {event.title}
                    </h5>
      ...
      <section className="py-12 sm:py-10 px-4 sm:px-6 lg:px-20 bg-gradient-to-br from-amber-50 via-lime-50 to-green-100 relative overflow-hidden">
        ...
        >
          <motion.h2
            className="text-3xl  md:text-4xl font-bold text-center text-green-900 md:mb-8 mb-4"
          ...
          <div className="relative px-8 sm:px-12 mb-4">
            <div className="">
              <AnimatePresence mode="wait">
                ...
                >
                  {getVisibleExperts().map((expert, i) => (
                    <motion.div
                      key={expert.name}
