  ...
  return (
    ...
    >
      {[
        {
          type: "title",
          text: <>आत्मन्मूलभूतसदस्यत्व (Self Basic Membership) </>,
        },
        {
          type: "heading",
        ...
        {
          type: "paragraphBold",
          text: "Gate way to the World of everything...  ",
        },
      ].map((block, index) => (
      ...
      {openModal && (
        <BarterMembershipForm
          ...
          text={
            <>
              * You will get 5% off on all bookings. <br />* Upgrade your
...
export default SelfBasicMembership;
