  ...
  return (
    ...
    >
      {[
        ...
        {
          type: "paragraph",
          text: "Each member carries an inner desire to reconnect with nature—to live in joint families, drink well water, eat wild forest produce, and experience a lifestyle in harmony with nature. This dream includes Ayurvedic homes, healing centers, herbal forests, cow shelters, and traditional Ayurvedic healthcare practices that have been sustained over thousands of years by hundreds of generations aiming for 100 years of healthy living. Despite owning large farmlands today, many farmers lack a consistent, chemical-free supply of pure grains, oils, jaggery, ghee, herbs, and Panchgavya throughout the year due to mono-cropping practices. If even they cannot access it, how can others? Most people have lost their native villages—whether it was their maternal home or ancestral land. ",
        },
        {
          type: "heading",
          text: "Swagram aims to recreate this lost connection through :",
          icon: <TbTargetArrow className="text-ayuBrown" />,
        },
        {
          type: "list",
          items: [
...
export default FriendsMembership;
